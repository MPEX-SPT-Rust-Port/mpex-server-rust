...
| `PrepatchLoadContext.cs` | `AssemblyLoadContext` ("SPT.PrepatchHost") serving the patched Core from memory while sharing framework/`MudBlazor`/Harmony assemblies with the default context |
