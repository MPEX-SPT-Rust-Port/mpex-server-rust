// Generated from the real Spectre.Console 0.57.2 assembly by reflecting over
// every public static Color property. Do not hand-edit: regenerate if the
// facade ever needs to track a different Spectre version.
//
// (name, r, g, b)
pub const COLORS: &[(&str, u8, u8, u8)] = &[
    ...
    ("DeepSkyBlue4_1", 0, 95, 135),
    ("DeepSkyBlue4_2", 0, 95, 175),
    ...
    ("Yellow3", 175, 215, 0),
    ("DarkOliveGreen3_2", 175, 215, 95),
    ("DarkSeaGreen3_1", 175, 215, 135),
    ("DarkSeaGreen2", 175, 215, 175),
    ("LightCyan3", 175, 215, 215),
    ("LightSkyBlue1", 175, 215, 255),
    ("GreenYellow", 175, 255, 0),
    ("DarkOliveGreen2", 175, 255, 95),
    ("PaleGreen1_1", 175, 255, 135),
    ("DarkSeaGreen2_1", 175, 255, 175),
    ("DarkSeaGreen1", 175, 255, 215),
    ("PaleTurquoise1", 175, 255, 255),
    ("Red3_1", 215, 0, 0),
    ("DeepPink3", 215, 0, 95),
    ("DeepPink3_1", 215, 0, 135),
    ("Magenta3_1", 215, 0, 175),
    ("Magenta3_2", 215, 0, 215),
    ("Magenta2", 215, 0, 255),
    ("DarkOrange3_1", 215, 95, 0),
    ("IndianRed_1", 215, 95, 95),
    ("HotPink3_1", 215, 95, 135),
    ("HotPink2", 215, 95, 175),
    ("Orchid", 215, 95, 215),
    ("MediumOrchid1", 215, 95, 255),
    ("Orange3", 215, 135, 0),
    ("LightSalmon3_1", 215, 135, 95),
    ...
    ("DarkOliveGreen1_1", 215, 255, 135),
    ("DarkSeaGreen1_1", 215, 255, 175),
    ("Honeydew2", 215, 255, 215),
    ("LightCyan1", 215, 255, 255),
    ("Red1", 255, 0, 0),
    ("DeepPink2", 255, 0, 95),
    ("DeepPink1", 255, 0, 135),
    ("DeepPink1_1", 255, 0, 175),
    ("Magenta2_1", 255, 0, 215),
    ("Magenta1", 255, 0, 255),
    ("OrangeRed1", 255, 95, 0),
    ("IndianRed1", 255, 95, 95),
    ("IndianRed1_1", 255, 95, 135),
    ("HotPink", 255, 95, 175),
    ("HotPink_1", 255, 95, 215),
    ("MediumOrchid1_1", 255, 95, 255),
    ...
    ("Plum1", 255, 175, 255),
    ("Gold1", 255, 215, 0),
    ("LightGoldenrod2_1", 255, 215, 95),
    ("LightGoldenrod2_2", 255, 215, 135),
